#ex62) 직업이 salesman이고 월급이 1200이상인 사원들의 이름,직업,월급을 출력하시오
import csv
...
#ex63)월급이 1000에서 3000사이인 사원들의 이름,월급을 출력하시오
import csv
file = open("/Users/misoni/Desktop/pythondata/emp2.csv",'r')
emp_csv = csv.reader(file)
for emp_list in emp_csv:
...
#ex65) 직업이 analyst, clerk이 아닌 사원들의 이름,월급 직업
import csv
file = open("/Users/misoni/Desktop/pythondata/emp2.csv",'r')
emp_csv = csv.reader(file)
for emp_list in emp_csv:
...
#ex66)커미션이 null인 사원들의 이름,커미션 출력

#ex67)커미션이 null이 아닌 사원들의 이름,커미션 출력
import csv
file = open("/Users/misoni/Desktop/pythondata/emp2.csv",'r')
emp_csv = csv.reader(file)
for emp_list in emp_csv:
...
#ex68)이름의 첫번째 철자로 S로 시작하는 사원들의 이름 월급을 출력
import csv
...
for emp_list in emp_csv:
    if emp_list[1][0] == 'S':
        print(emp_list[1],emp_list[6])
#ex69)이름의 두번째 철자가 m인 사원들의 이름,월급 출력
import csv
file = open("/Users/misoni/Desktop/pythondata/emp_comm.csv",'r')
emp_csv = csv.reader(file)
for emp_list in emp_csv:
...
#ex70) 이름의 마지막 철자가 H인 사원들의 이름,월급 출력
import csv
file = open("/Users/misoni/Desktop/pythondata/emp2.csv",'r')
emp_csv = csv.reader(file)
for emp_list in emp_csv:
